...
if [ $1 == "a" ]; then
  QEMU_OPTIONS="-net socket,listen=:8010 -net nic,model=ne2k_pci,macaddr=52:54:00:00:00:01" \
  MAC="52:54:00:00:00:01" \
  make qemu E=dom0_server_only MODULES_LIST=$MODULES_LIST MODULE_SEARCH_PATH=$MODULE_SEARCH_PATH &
elif [ $1 == "b" ]; then 
  QEMU_OPTIONS="-net socket,connect=127.0.0.1:8010 -net nic,model=ne2k_pci,macaddr=52:54:00:00:00:02" \
