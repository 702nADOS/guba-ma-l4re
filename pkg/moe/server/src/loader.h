...
public:
  ...
  L4::Cap<L4::Thread> startac(cxx::String const &args);
  bool exec(cxx::String const &prog, cxx::String const &args);

  L4::Cap<L4::Thread> execac(cxx::String const &args);
  virtual bool launch(App_task *, cxx::String const &, cxx::String const &) = 0;

  virtual L4::Cap<L4::Thread> launchac(App_task *, cxx::String const &) = 0;
  virtual ~Loader() {}
};
